...
include 'db_connection.php'; // Pastikan file ini sudah benar dan terhubung ke database Anda
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM user WHERE username = ? AND role = 'petugas'";
    ...
    if ($result->num_rows == 1) {
        ...
        $error = "Username tidak ditemukan atau Anda bukan petugas.";
    }
}
?>
...
<head>
    ...
    <style>
        /* Tambahkan CSS sesuai desain Anda */
        * {
            margin: 0;
            padding: 0;
